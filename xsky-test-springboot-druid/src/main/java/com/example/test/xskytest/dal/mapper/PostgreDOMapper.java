...
@Mapper
public interface PostgreDOMapper {
    ...
    List<SqlDO> postgreSqlTestException(@Param("tableName") String tableName, @Param("id") String id);


    @Select("select pg_sleep(${sleepTime}),count(*) from ${tableName}")
