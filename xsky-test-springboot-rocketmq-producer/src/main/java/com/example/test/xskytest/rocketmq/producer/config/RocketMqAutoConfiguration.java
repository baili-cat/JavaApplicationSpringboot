...
import com.example.test.xskytest.common.constants.RocketMQErrorEnum;
import com.example.test.xskytest.common.exception.RocketMQException;
 ...
 * @Description: 参考来源：https://github.com/hu1991die/rocketmq-springboot-starter/blob/master/src/main/java/com/feizi/starter/RocketMqSendTemplate.java
 * @version: v1.0.0
 * @author: baili
 * @date: 2022年8月6日 下午21:44:36
 */
@Configuration
...
//    @ConditionalOnClass(DefaultMQProducer.class)
    ...
    public DefaultMQProducer mqProducer() {
        ...
        log.info("rocketMq name-server: {}, producer-config.group: {}", nameServer, producerGroup);
