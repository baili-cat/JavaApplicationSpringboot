...
public class DefaultRocketMqListenerContainer  implements InitializingBean, RocketMqConsumerListenerContainer {
    ...
    public void destroy() throws Exception {
        ...
        log.info("rocketMq defaultRocketMQListenerContainer destroyed, {}", this.toString());
    }
    ...
    public synchronized void start() throws MQClientException {
        ...
        log.info("rocketMq receive the msgType: {}", messageType.getName());
        ...
        log.info("rocketMq start consumer listener container: {}", this.toString());
    }
    ...
    public class DefaultMessageListenerConcurrently implements MessageListenerConcurrently {
        ...
        public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
            for (MessageExt messageExt : msgs) {
                try {
                    log.info("rocketMq consumer received message: {}", messageExt);
                    ...
                    log.info("rocketMq consume msgId: {}, cost: {} ms", messageExt.getMsgId(), (end - begin));
                } catch (Exception e) {
                    log.error("rocketMq consume message failed. msg: {}", messageExt, e);
    ...
    private void initRocketMQPushConsumer() throws MQClientException {
        ...
        log.info("rocketMq initRocketMQPushConsumer, rocketMqConsumerListener: {}, consumerGroup: {}, nameServer: {}, topic: {}",
        ...
        // 判断消费选择器
        log.info("rocketMq selectorType is: {}", selectorType.name());
        switch (selectorType){
            case TAG:
        ...
        log.info("rocketMq consumeMode is: {}", consumeMode.name());
        switch (consumeMode){
            case ORDERLY:
